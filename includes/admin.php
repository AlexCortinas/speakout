...
function dk_speakout_create_menus() {
	...
	add_submenu_page( "dk_speakout", $petitions['page_title'], "Petitions", $petitions['capability'], $petitions['menu_slug'], $petitions['function'], $petitions['icon_url'] );
	...
	$import = array(
		'parent_slug' => 'dk_speakout',
		'page_title'  => __( 'Import from SpeakUp', 'speakout' ),
		'menu_title'  => __( 'Import from SpeakUp', 'speakout' ),
		'capability'  => 'manage_options',
		'menu_slug'   => 'dk_speakout_import',
		'function'    => 'dk_speakout_import_page'
	);

	$import_page = add_submenu_page( $import['parent_slug'], $import['page_title'], $import['menu_title'], $import['capability'], $import['menu_slug'], $import['function'] );
