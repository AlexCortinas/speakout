...
<div id="poststuff">
	...
	<div id="post-body" class="metabox-holder columns-2">
		<div id="post-body-content">
			...
			<div id="titlediv">
				<div id="titlewrap">
					<label class="hide-if-no-js" style="visibility:hidden" id="title-prompt-text" for="title"><?php _e( 'Enter title here', 'speakout' ); ?></label>
			...
			<div class="postbox">
				...
				<h3 class='hndle'><?php _e( 'Petition', 'speakout' ); ?></h3>
				<div class="inside">
					...
					<div class="dk-speakout-petition-content">
						<div class="dk-speakout-email-headers">
							<label for="target_email"><?php _e( 'Target Email', 'speakout' ); ?> <span class='normalText'>you may enter multiple addresses separated by commas</span></label> 
							<input name="target_email" id="target_email" value="<?php echo esc_attr( $petition->target_email ); ?>" size="40" maxlength="300" type="text" />

							<label for="email_subject"><?php _e( 'Email Subject', 'speakout' ); ?></label>
			...
			<div class="postbox">
				<div class="handlediv" title="Click to toggle"><br /></div>
				<h3 class='hndle'><?php _e( 'Twitter Message', 'speakout' ); ?></h3>
				<div class="inside">
		...
		<div id="side-sortables" class="meta-box-sortables">
			...
			<div class="postbox">
				<div class="handlediv" title="Click to toggle"><br /></div>
				<h3 class='hndle'><?php _e( 'Petition Options', 'speakout' ); ?></h3>
				<div class="inside">
					...
					<div id="minor-publishing">
						...
						<div class="misc-pub-section">
							<div class="dk-speakout-checkbox">
								...
								<label for="requires_confirmation" class="dk-speakout-inline"><?php _e( 'Confirm signatures', 'speakout'); ?></label>
							</div>
			...
			<div class="postbox">
				<div class="handlediv" title="Click to toggle"><br /></div>
				<h3 class='hndle'><?php _e( 'Display Options', 'speakout' ); ?></h3>
				<div class="inside">
					...
					<div id="minor-publishing">
						...
						<div class="misc-pub-section">
							<div class="dk-speakout-checkbox">
								...
								<label for="displays-custom-field" class="dk-speakout-inline"><?php _e( 'Display custom field', 'speakout'); ?></label>
							</div>
						...
						<div class="misc-pub-section">
							...
							<div class="dk-speakout-custom-message dk-speakout-subsection <?php if( $petition->displays_custom_message != 1 ) echo 'dk-speakout-hidden'; ?>">
						...
						<div class="misc-pub-section misc-pub-section-last">
							<div class="dk-speakout-checkbox">
								...
								<label for="displays-optin" class="dk-speakout-inline"><?php _e( 'Display opt-in checkbox', 'speakout'); ?></label>
							</div>
