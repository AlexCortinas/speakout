...
function dk_speakout_addnew_page() {
	...
	switch( $action ) {
		...
		case 'create' :
			...
			$page_title  = __( 'Edit Email Petition', 'speakout' );
			...
			$start_tag               = '<strong>';
			$end_tag                 = '</strong>';
			$message_text            = __( 'Petition created. Use %1$s %2$s %3$s to display in a page or post. Use %1$s %4$s %3$s to display the signatures list.', 'speakout' );
		...
		case 'update' :
			...
			// set up page display variables
			$page_title     = __( 'Edit New Email Petition', 'speakout' );
			$nonce          = 'dk_speakout-update_petition' . $petition->id;
			$action         = 'update';
			$x_date         = $petition->get_expiration_date_components();
			$button_text    = __( 'Update Petition', 'speakout' );
		...
		default :
			// set up page display variables
			$page_title     = __( 'Add New Email Petition', 'speakout' );
