<div class="wrap" id="dk-speakout">
	...
	<div class="tablenav">
		...
		<?php echo dk_speakout_SpeakOut::pagination( $query_limit, $count, 'speakout', $current_page, site_url( 'wp-admin/admin.php?page=dk_speakout' ), true ); ?>
	</div>
	...
	<table class="widefat">
		...
		<?php foreach ( $petitions as $petition ) : ?>
			...
			<tr class="dk-speakout-tablerow">
				<td>
					<a class="row-title" href="<?php echo $edit_url; ?>"><?php echo stripslashes( esc_html( $petition->id ) ); ?></a>
