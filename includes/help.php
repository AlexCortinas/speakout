...
function dk_speakout_help_addnew() {
	...
	$tab_petition_options = '
		...
		<p><strong>' . __( "Allow messages to be edited", "dk_speakout" ) . '</strong>&mdash;' . __( "Check this option to allow signatories to customize the text of their petition email.", "dk_speakout" ) . '</p>
...
function dk_speakout_help_settings() {
	...
	$tab_admin_display = '
		...
		<p><strong>' . __( "Petitions table shows", "dk_speakout" ) . '</strong>&mdash;' . __( "Enter the number of rows to display in the \"Email Petitions\" table (default=20)", "dk_speakout" ) . '</p>
		<p><strong>' . __( "Signatures table shows", "dk_speakout" ) . '</strong>&mdash;' . __( "Enter the number of rows to display in the \"Signatures\" table (default=50)", "dk_speakout" ) . '</p>
