		...
		if ( $get_petition ) {
			...
			if ( $expired ) {
				$petition_widget .= '
							...
							<p>' . __( 'Signatures collected', 'speakout' ) . ': ' . $petition->signatures . '</p>';
				if ( $petition->goal != 0 ) {
					$petition_widget .= '
							<p><div class="dk-speakout-expired-goal"><span>' . __( 'Signature goal', 'speakout' ) . ':</span> ' . $petition->goal . '</div></p>';
				}
			}
			else {
				$petition_widget .= '
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-first-name-' . $petition->id . '" class="required">' . __( 'First Name', 'speakout' ) . '</label>
								<input name="dk-speakout-widget-first-name" id="dk-speakout-widget-first-name-' . $petition->id . '" value="' . $userdata['firstname'] . '" type="text" />
							</div>
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-last-name-' . $petition->id . '" class="required">' . __( 'Last Name', 'speakout' ) . '</label>
								<input name="dk-speakout-widget-last-name" id="dk-speakout-widget-last-name-' . $petition->id . '" value="' . $userdata['lastname'] . '" type="text" />
							</div>
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-email-' . $petition->id . '" class="required">' . __( 'Email', 'speakout' ) . '</label>
				...
				if ( $petition->requires_confirmation ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-email-confirm-' . $petition->id . '" class="required">' . __( 'Confirm Email', 'speakout' ) . '</label>
				...
				if ( in_array( 'street', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-full">
								<label for="dk-speakout-widget-street-' . $petition->id . '">' . __( 'Street', 'speakout' ) . '</label>
				...
				if ( in_array( 'city', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-half">
								<label for="dk-speakout-widget-city-' . $petition->id . '">' . __( 'City', 'speakout' ) . '</label>
				...
				if ( in_array( 'state', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-half">
								<label for="dk-speakout-widget-state-' . $petition->id . '">' . __( 'State / Province', 'speakout' ) . '</label>
				...
				if ( in_array( 'postcode', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-half">
								<label for="dk-speakout-widget-postcode-' . $petition->id . '">' . __( 'Post Code', 'speakout' ) . '</label>
				...
				if ( in_array( 'country', $petition->address_fields ) ) {
					$petition_widget .= '
							<div class="dk-speakout-widget-half">
								<label for="dk-speakout-widget-country-' . $petition->id . '">' . __( 'Country', 'speakout' ) . '</label>
				...
				if( $petition->displays_optin == 1 ) {
					...
					if ( $options['display_bcc'] == 'enabled' ) {
					    $petition_widget .= '
								...
								<input type="checkbox" name="dk-speakout-widget-bcc" id="dk-speakout-widget-bcc-' . $petition->id . '" CHECKED  />
