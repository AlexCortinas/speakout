		...
		if ( $petition_exists ) {
			...
			if ( ! $expired ) {
					...
					<div class="dk-speakout-petition-wrap ' . $css_classes . '" id="dk-speakout-petition-' . $petition->id . '" ' . $width . '>
						...
						<form class="dk-speakout-petition">
							...
							<div class="dk-speakout-full">
								<label for="dk-speakout-first-name-' . $petition->id . '" class="required">' . __( 'First Name', 'speakout' ) . '<span class="translation"> First Name</span></label>
								<input name="dk-speakout-first-name" id="dk-speakout-first-name-' . $petition->id . '" value="' . $userdata['firstname'] . '" type="text" />
							</div>
							
							<div class="dk-speakout-full">
								<label for="dk-speakout-last-name-' . $petition->id . '" class="required">' . __( 'Last Name', 'speakout' ) . '<span class="translation"> Last Name</span></label>
				...
				if ( $petition->requires_confirmation ) {
					$petition_form .= '
							<div class="dk-speakout-full">
								<label for="dk-speakout-email-confirm-' . $petition->id . '" class="required">' . __( 'Confirm Email', 'speakout' ) . '<span class="translation"> Email</span></label>
				...
				if ( in_array( 'street', $petition->address_fields ) ) {
					$petition_form .= '
							<div class="dk-speakout-full">
								<label for="dk-speakout-street-' . $petition->id . '">' . __( 'Street', 'speakout' ) . '<span class="translation"> Organization / Profession</span></label>
				...
				if ( in_array( 'city', $petition->address_fields ) ) {
					$petition_form .= '
							<div class="dk-speakout-half">
								<label for="dk-speakout-city-' . $petition->id . '">' . __( 'City', 'speakout' ) . '<span class="translation"> City</span></label>
				...
				if ( in_array( 'postcode', $petition->address_fields ) ) {
					$petition_form .= '
							<div class="dk-speakout-half">
								<label for="dk-speakout-postcode-' . $petition->id . '">' . __( 'Post Code', 'speakout' ) . '</label>
				...
				if ( in_array( 'country', $petition->address_fields ) ) {
					$petition_form .= '
							<div class="dk-speakout-half">
								<label for="dk-speakout-country-' . $petition->id . '">' . __( 'Country', 'speakout' ) . '<span class="translation"> Country</span></label>
				...
				if ( $petition->displays_custom_field == 1 ) {
					$petition_form .= '
							<div class="dk-speakout-full">
								<label for="dk-speakout-custom-field-' . $petition->id . '" class="required">' . stripslashes( esc_html( $petition->custom_field_label ) ) . '<span class="translation"> ID</span></label>
				...
				if ( $options['display_bcc'] == 'enabled' ) {
				    $petition_form .= '
								...
								<input type="checkbox" name="dk-speakout-bcc" id="dk-speakout-bcc-' . $petition->id . '" CHECKED />
								<label for="dk-speakout-bcc-' . $petition->id . '">' . __( 'BCC yourself', 'speakout' ) . '</label>
							</div>';
				}
